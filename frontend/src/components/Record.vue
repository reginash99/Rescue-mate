...
<div v-if="isRecording">
     <div >
                <video src="./media/vecteezy_audio-spectrum-line-animation-with-2d-concept-and-white_9863295_trimmed.mp4"  autoplay loop muted :width="clientWidth-Padding.right" height="250"></video> 
            </div>
</div>
</div>

    <!--:width="svgWidth" :height="svgHeight"-->
    <!--<div id="Record"   ref="record_component" :width="clientWidth" :height="clientHeight" :align="left"> 
                <h5>Recording Section</h5>
            <div v-if="!isRecording">
                <button type="button" class="btn btn-danger" id="recordButton" @click="startRecording" >
            ...
            <div :width="clientWidth-Padding.right" height="250">
            </div>
            </div>
            <div v-if="isRecording">
                 <button type="button" class ="btn btn-danger" id="stopRecordButton" @click="stopRecording" > 
